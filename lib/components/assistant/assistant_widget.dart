        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                'Assistant is an ai tool that will help you generate high quality text for your event.  It will help with copywriting, description writing, title writing, marketing ideas and more.',
            ...
            Align(
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('ASSISTANT_COMP_GENERATE_BTN_ON_TAP');
                  logFirebaseEvent('Button_custom_action');
                  _model.gpt3output = await actions.gpt3(
                    'Bearer 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',
