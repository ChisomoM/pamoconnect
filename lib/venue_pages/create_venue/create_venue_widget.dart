...
class _CreateVenueWidgetState extends State<CreateVenueWidget> {
  ...
  void initState() {
    ...
    _model.venueDescriptionController ??= TextEditingController();
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: TextFormField(
                                      controller:
                                          _model.venueDescriptionController,
                                      focusNode:
                                          _model.venueDescriptionFocusNode,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                      ...
                                      minLines: 3,
                                      validator: _model
                                          .venueDescriptionControllerValidator
                                          .asValidator(context),
                                    ),
                                  ),
                                ],
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              try {
                                  ...
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return WebViewAware(
                                        ...
                                        content: Text(
                                            'Please Select Your Venue\'s Location'),
                                        actions: [
                                          TextButton(
                                ...
                                if (_model.venueTypeValue == null) {
                                  await showDialog(
                                    context: context,
                                    builder: (alertDialogContext) {
                                      return WebViewAware(
                                          child: AlertDialog(
                                        title: Text('Select Venue Type'),
                                        content:
                                            Text('Please Select Venue Type'),
                                        actions: [
                                          TextButton(
                                            onPressed: () => Navigator.pop(
                                                alertDialogContext),
                                ...
                                firestoreBatch.set(venuesRecordReference, {
                                  ...createVenuesRecordData(
                                    ...
                                    venueDescription:
                                        _model.venueDescriptionController.text,
                                    venueAddress:
