              ...
              actions: [
                Row(
                  ...
                  children: [
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(0.0, 8.0, 8.0, 2.0),
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(0.0, 8.0, 12.0, 2.0),
                      child: FlutterFlowIconButton(
                        borderColor: Colors.transparent,
                        borderRadius: 12.0,
                        borderWidth: 1.0,
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: AuthUserStreamWidget(
                                    builder: (context) => Text(
                                      valueOrDefault(
                                          currentUserDocument?.performerType,
                                          ''),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                ...
                                StreamBuilder<List<BookingRequestsRecord>>(
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<BookingRequestsRecord>
                                        columnBookingRequestsRecordList =
                                        snapshot.data!;
                                    return Column(
                                      mainAxisSize: MainAxisSize.max,
                                                              ...
                                                              Expanded(
                                                                child: RichText(
                                                                  ...
                                                                  text:
                                                                    ...
                                                                    children: [
                                                                      TextSpan(
                                                                        text: columnBookingRequestsRecord
                                                                            .eventName,
                                                                        style: FlutterFlowTheme.of(context)
                                                                            .bodyMedium
                                                                            .override(
