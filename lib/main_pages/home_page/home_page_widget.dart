...
class _HomePageWidgetState extends State<HomePageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if (valueOrDefault(currentUserDocument?.accountType, '') == 'Performer') {
                ...
                children: [
                  Expanded(
                    child: InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent(
                            'HOME_PAGE_PAGE_Container_o50l40ff_ON_TAP');
                        logFirebaseEvent('WelcomeName_navigate_to');
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    ...
                                    logFirebaseEvent('MyEvents_navigate_to');
                                ...
                                Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      ...
                                      logFirebaseEvent('Venues_navigate_to');
