                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'SIGN_UP_PAGE_PAGE_NEXT_BTN_ON_TAP');
                                        ...
                                        await showDialog(
                                          ...
                                          builder: (alertDialogContext) {
                                            return WebViewAware(
                                              ...
                                              content: Text(
                                                  'A verification email has been sent to the ${_model.emailAddressController.text}. Please verify your email to gain access to more features.'),
                                              actions: [
                                                TextButton(
                                                  onPressed: () =>
                                                      Navigator.pop(
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'SIGN_UP_RichText_twppnpdl_ON_TAP');
                                          logFirebaseEvent(
