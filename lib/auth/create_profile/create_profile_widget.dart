            ...
            children: [
              Expanded(
                child: Form(
                  ...
                  child: Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(12.0, 12.0, 12.0, 36.0),
                                ...
                                Expanded(
                                  child: AuthUserStreamWidget(
                                    builder: (context) =>
                                      ...
                                      onChanged: (val) => setState(() =>
                                          _model.performerDropDownValue = val),
                                      width: 180.0,
                                      height: 50.0,
                                      textStyle: FlutterFlowTheme.of(context)
                                          .bodyMedium
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                          ...
                          await showDialog(
                            ...
                            builder: (alertDialogContext) {
                              return WebViewAware(
                                  child: AlertDialog(
                                title:
                                    Text('You have not entered your birthdate'),
                        ...
                        await currentUserReference!
                          ...
                          city: _model.placePickerValue.latLng?.toString(),
                        ));
                        if (valueOrDefault(
                                currentUserDocument?.accountType, '') ==
                            'Venue') {
