...
class EditEventWidget extends StatefulWidget {
  ...
  final DocumentReference? cEvent;
  final bool isCreate;
...
class _EditEventWidgetState extends State<EditEventWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<EventsRecord>(
      stream: EventsRecord.getDocument(widget.cEvent!),
      builder: (context, snapshot) {
        ...
        final editEventEventsRecord = snapshot.data!;
                    ...
                    children: [
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      logFirebaseEvent(
                                          'EDIT_EVENT_PAGE_userImage_ON_TAP');
                                      logFirebaseEvent(
                                      ...
                                      logFirebaseEvent(
                                          'userImage_backend_call');

                                      await editEventEventsRecord.reference
                                          .update(createEventsRecordData(
                                        eventPoster: _model.uploadedFileUrl,
                                      ));
                                      logFirebaseEvent(
                                          'userImage_show_snack_bar');
                                      ScaffoldMessenger.of(context)
                                          .showSnackBar(
                                        SnackBar(
                                          content: Text(
                                        ...
                                        image: DecorationImage(
                                          ...
                                          image: Image.network(
                                            valueOrDefault<String>(
                                              editEventEventsRecord.eventPoster,
                                ...
                                Padding(
                                  ...
                                  child: TextFormField(
                                    controller: _model.eventNameController ??=
                                      ...
                                      text: editEventEventsRecord.eventName,
                                    ),
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      suffixIcon: _model.eventNameController!
                                              .text.isNotEmpty
                                          ? InkWell(
                                              onTap: () async {
                                                _model.eventNameController
                                                                ...
                                                                child: Padding(
                                                                  padding: EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          0.0),
                                                                  child: Text(
                                                                    'Tap here to edit details such as age limit, refund policy, dress code...',
                                  ...
                                  child: FlutterFlowDropDown<String>(
                                    controller:
                                      ...
                                      _model.dropDownValue ??=
                                          editEventEventsRecord.category,
                                    ),
                                    options: [
                                      'Concert',
                                      'Party',
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'EDIT_EVENT_PAGE_StartDate_ON_TAP');
                                          logFirebaseEvent(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'EDIT_EVENT_PAGE_endDate_ON_TAP');
                                          logFirebaseEvent(
                      ...
                      if (widget.isCreate == true)
                        FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'EDIT_EVENT_PAGE_CREATE_EVENT_BTN_ON_TAP');
                      ...
                      if (widget.isCreate == false)
                        FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'EDIT_EVENT_PAGE_UPDATE_BTN_ON_TAP');
                            logFirebaseEvent('Button_backend_call');

                            await widget.cEvent!.update(createEventsRecordData(
                              eventName: _model.eventNameController.text,
                              eventPoster: _model.uploadedFileUrl != null &&
                                      _model.uploadedFileUrl != ''
                                  ? _model.uploadedFileUrl
                                  : editEventEventsRecord.eventPoster,
                              eventDescription:
                            ...
                            if (widget.previousDate != _model.datePicked1) {
                              logFirebaseEvent(
                                  'Button_trigger_push_notification');
                              triggerPushNotification(
                                notificationTitle:
                                    '${editEventEventsRecord.eventName} event date has changed',
                                notificationText:
                                    'The date on which ${editEventEventsRecord.eventName}has changed. Click here to view the details',
