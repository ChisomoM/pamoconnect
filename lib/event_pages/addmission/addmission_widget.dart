...
class AddmissionWidget extends StatefulWidget {
  ...
  @override
  _AddmissionWidgetState createState() => _AddmissionWidgetState();
}

class _AddmissionWidgetState extends State<AddmissionWidget> {
  late AddmissionModel _model;
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Addmission'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('ADDMISSION_PAGE_Addmission_ON_INIT_STATE');
      logFirebaseEvent('Addmission_request_permissions');
                ...
                Builder(
                  builder: (context) => Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'ADDMISSION_PAGE_SCAN_TICKET_BTN_ON_TAP');
