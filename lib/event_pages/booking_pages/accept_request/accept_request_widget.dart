          ...
          child: Scaffold(
            ...
            body: SafeArea(
              ...
              child: Padding(
                ...
                child: StreamBuilder<List<VenueRequestRecord>>(
                  stream: queryVenueRequestRecord(
                    parent: widget.eventRef,
                    queryBuilder: (venueRequestRecord) =>
                        venueRequestRecord.where(
                      'venue_ref',
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<VenueRequestRecord> columnVenueRequestRecordList =
                        snapshot.data!;
                    final columnVenueRequestRecord =
                        columnVenueRequestRecordList.isNotEmpty
                            ? columnVenueRequestRecordList.first
                            : null;
                                  ...
                                  Expanded(
                                    child: Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 4.0, 0.0, 0.0),
                                      child: Text(
                                        columnVenueRequestRecord!.offerDetails,
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Montserrat',
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    await widget.eventRef!
                                      ...
                                      eventVenue:
                                          columnVenueRequestRecord?.venueRef,
                                      verifiedVenue: true,
                                      hasVenue: true,
                                    ));
                                    logFirebaseEvent(
