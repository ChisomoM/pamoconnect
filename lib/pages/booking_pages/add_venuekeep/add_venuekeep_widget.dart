...
import 'add_venuekeep_model.dart';
export 'add_venuekeep_model.dart';

class AddVenuekeepWidget extends StatefulWidget {
  const AddVenuekeepWidget({
    Key? key,
    this.event,
  }) : super(key: key);
  ...
  @override
  _AddVenuekeepWidgetState createState() => _AddVenuekeepWidgetState();
}

class _AddVenuekeepWidgetState extends State<AddVenuekeepWidget> {
  late AddVenuekeepModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddVenuekeepModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'addVenuekeep'});
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('ADD_VENUEKEEP_arrow_back_rounded_ICN_ON_');
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'ADD_VENUEKEEP_search_rounded_ICN_ON_TAP');
                                    logFirebaseEvent(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  FFButtonWidget(
                                                    onPressed: () async {
                                                      logFirebaseEvent(
                                                          'ADD_VENUEKEEP_PAGE_SELECT_BTN_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Button_backend_call');

                                                      await widget.event!.update(
                                                      ...
                                                      ScaffoldMessenger.of(
                                                        ...
                                                        SnackBar(
                                                          content: Text(
                                                            'Your Venue has been set as the venue for the event',
                                                            style: GoogleFonts
                                                                .getFont(
                                                              'Montserrat',
                                            ...
                                            Column(
                                              ...
                                              children: [
                                                FFButtonWidget(
                                                  onPressed: () async {
                                                    logFirebaseEvent(
                                                        'ADD_VENUEKEEP_PAGE_VIEW_BTN_ON_TAP');
                                                    logFirebaseEvent(
                                                        'Button_navigate_to');
