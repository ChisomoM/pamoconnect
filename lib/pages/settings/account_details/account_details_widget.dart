      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('ACCOUNT_DETAILS_arrow_back_rounded_ICN_O');
            ...
            children: [
              ...
              if (_model.isEdit == 'False')
                FlutterFlowIconButton(
                  ...
                  onPressed: () async {
                    logFirebaseEvent('ACCOUNT_DETAILS_edit_rounded_ICN_ON_TAP');
              ...
              if (_model.isEdit != 'False')
                InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent('ACCOUNT_DETAILS_Text_2n5z9lpc_ON_TAP');
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'ACCOUNT_DETAILS_Container_tu8zb80t_ON_TA');
                                            logFirebaseEvent(
                            ...
                            Row(
                              ...
                              children: [
                                InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'ACCOUNT_DETAILS_Text_hf4zlqgd_ON_TAP');
                                ...
                                children: [
                                  Expanded(
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'ACCOUNT_DETAILS_PAGE_SaveButton_ON_TAP');
                                        logFirebaseEvent(
