          ...
          routes: [
            ...
            FFRoute(
              ...
              builder: (context, params) => EventsWidget(
                draftsQuery: params.getParam('draftsQuery', ParamType.String),
              ),
            ),
            FFRoute(
              name: 'EditEvent',
              ...
              builder: (context, params) => EditEventWidget(
                cEvent: params.getParam(
                    'cEvent', ParamType.DocumentReference, false, ['events']),
                isCreate: params.getParam('isCreate', ParamType.bool),
                previousDate:
                    params.getParam('previousDate', ParamType.DateTime),
              ),
            ),
            FFRoute(
              name: 'selectAccountType',
              path: 'selectAccountType',
              builder: (context, params) => SelectAccountTypeWidget(),
            ),
            FFRoute(
              name: 'createProfile',
              path: 'createProfile',
            ...
            FFRoute(
              name: 'connectCenter',
              path: 'connectCenter',
              builder: (context, params) => ConnectCenterWidget(
                eve: params.getParam(
                    'eve', ParamType.DocumentReference, false, ['events']),
                isEdit: params.getParam('isEdit', ParamType.String),
              ),
            ),
            FFRoute(
              name: 'Addmission',
              path: 'addmission',
              builder: (context, params) => AddmissionWidget(
            ...
            FFRoute(
              ...
              builder: (context, params) => VenueDetailsWidget(
                venue: params.getParam(
                    'venue', ParamType.DocumentReference, false, ['venues']),
              ),
            ),
            FFRoute(
              name: 'addPerformer',
              path: 'addPerformer',
              builder: (context, params) => AddPerformerWidget(
                event: params.getParam(
                    'event', ParamType.DocumentReference, false, ['events']),
              ),
            ),
            ...
            FFRoute(
              ...
              builder: (context, params) => UnderConstructionWidget(),
            ),
            FFRoute(
              name: 'AccountDetails',
              path: 'accountDetails',
            ...
            FFRoute(
              ...
              builder: (context, params) => EventDetailsViewWidget(
                eventDetails: params.getParam('eventDetails',
                    ParamType.DocumentReference, false, ['events']),
              ),
            ),
            FFRoute(
              name: 'AcceptRequest',
              path: 'acceptRequest',
              builder: (context, params) => AcceptRequestWidget(
                eventRef: params.getParam(
                    'eventRef', ParamType.DocumentReference, false, ['events']),
              ),
            ),
            FFRoute(
              name: 'DeletedPage',
              path: 'deletedPage',
              builder: (context, params) => DeletedPageWidget(),
            ),
            FFRoute(
              name: 'stats',
              path: 'stats',
            ...
            FFRoute(
              name: 'extraDetails',
              path: 'extraDetails',
              builder: (context, params) => ExtraDetailsWidget(
                eventRef: params.getParam(
                    'eventRef', ParamType.DocumentReference, false, ['events']),
            ...
            FFRoute(
              name: 'GenerateTicketPage',
              path: 'generateTicketPage',
              builder: (context, params) => GenerateTicketPageWidget(
                eventRef: params.getParam(
                    'eventRef', ParamType.DocumentReference, false, ['events']),
                eventName: params.getParam('eventName', ParamType.String),
                ticketName: params.getParam('ticketName', ParamType.String),
                ticketPrice: params.getParam('ticketPrice', ParamType.double),
                ticketRef: params.getParam('ticketRef',
                    ParamType.DocumentReference, false, ['events', 'tickets']),
              ),
            ),
            FFRoute(
              name: 'performerHome',
              path: 'performerHome',
              builder: (context, params) => PerformerHomeWidget(),
            ),
            FFRoute(
              name: 'editPerformerP',
              path: 'editPerformerP',
