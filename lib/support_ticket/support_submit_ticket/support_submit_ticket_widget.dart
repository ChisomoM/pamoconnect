...
class SupportSubmitTicketWidget extends StatefulWidget {
  const SupportSubmitTicketWidget({Key? key}) : super(key: key);

  @override
  _SupportSubmitTicketWidgetState createState() =>
                                ...
                                children: [
                                      ...
                                      Expanded(
                                        child: Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'SUPPORT_SUBMIT_TICKET_Container_gy9vh5jc');
                                              logFirebaseEvent(
                                      ...
                                      Expanded(
                                        child: Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'SUPPORT_SUBMIT_TICKET_Container_7xthkj4s');
                                              logFirebaseEvent(
                                                  'Container_send_email');
                                              await launchUrl(Uri(
                                                  scheme: 'mailto',
                                                  path: 'support@pamo.events',
                                                  query: {
                                                    'subject':
                                                        'I need help with Pamo Connect',
                                                  }
                                                      .entries
                                                      .map((MapEntry<String,
                                                                  String>
                                  ...
                                  Align(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'SUPPORT_SUBMIT_TICKET_Container_odspqlqd');
                                        logFirebaseEvent(
